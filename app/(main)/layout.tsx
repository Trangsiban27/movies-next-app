...
const layout = ({ children }: { children: React.ReactNode }) => {
    ...
    return (
        <div className="flex h-screen w-full bg-[#0D0D0D] text-gray-100 overflow-hidden">
            ...
            {/* <aside className={`md:flex flex-col border-r border-white/5 bg-[#0D0D0D] ${isOpen ? 'w-65' : 'w-0 -ml-65 md:ml-0 md:w-0 overflow-hidden border-none'}`}>
                <Sidebar />
            </aside> */}
            ...
            <div className="flex flex-1 flex-col relative overflow-hidden">
                ...
                <main className="flex-1 overflow-y-auto lg:px-8 pb-8 custom-scrollbar">
